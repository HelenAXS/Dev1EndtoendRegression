...
namespace Dev1EndtoendRegression.StepDefinitions
{
    ...
    internal class PackageStepDefinition
    {
        ...
        {
            string selector = $"a.btn.tickets[href='/Tickets/ChooseTickets?Id=359&IsSeason=False']"; //change the event ID here
            await _pageObject.ClickButtonsAndMenuOptionsAsync(selector);
        }
            ...
            string[] seatSelectors = new string[]
{
        ...
        public async Task WhenPressTheButtonToTheCartAsync(string goFurther)
        {
